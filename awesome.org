...
*** Battery 
    ...
    Battery will show dialog when the battery is empty.
    Warning and error icons will be shown on the battert icon
...
*** Functionality to launch applications or switch to them
...
*** TODO Popup with additional info
** Code
*** TODO Make rc.lua in org mode
*** TODO Make camle casing to use _
